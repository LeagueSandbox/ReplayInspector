...
namespace PcapDecrypt
{
    ...
    public enum PacketCmdS2C : byte
    {
        ...
        PKT_S2C_PlayerReconnect = 0x0F,
        PKT_S2C_EndSpawn = 0x11,
        PKT_S2C_SkillUp = 0x15,
        PKT_S2C_ChangeSpellSlot = 0x17,
        PKT_S2C_FloatingText = 0x19,
